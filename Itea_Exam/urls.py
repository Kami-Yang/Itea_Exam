...
urlpatterns = [
    ...
    path('app/', include(('app01.urls', 'app01'), namespace='app01')),
    path('exam/', include(('exam.urls', 'exam'), namespace='exam')),
    path('question_lib/', include(('question_lib.urls', 'question_lib'), namespace='question_lib')),
