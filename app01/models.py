...
class Question(models.Model):
    ...
    que_type = models.CharField(max_length=1, choices=TYPE_CHOICE, null=False)
...
class ExamRecord(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    # name = models.CharField(verbose_name="name", null=False, max_length=32)
    employee = models.ForeignKey(Employee, related_name='exam_record', on_delete=models.CASCADE)
    # join_date = models.DateTimeField(verbose_name="join date", null=False)
    score = models.IntegerField(verbose_name="score", default=0, null=False)
    exam_date = models.DateTimeField(verbose_name="date of exam", default=timezone.now, blank=True)
    ...
    is_pass = models.BooleanField(default=0, verbose_name="is pass ?", null=False)
